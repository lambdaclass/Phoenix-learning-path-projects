...
const msg = document.getElementById('user-msg');        // message input field
...
function render_message(payload) {
  ...
  <div class="flex flex-row w-[95%] mx-2 border-b-[1px] border-slate-300 py-2">
    <div class="text-left w-4/5 font-semibold text-slate-100 break-words">
      ${payload.name}:
      <div class="flex mx-1 grow text-white">
        ${payload.message}
      </div>
